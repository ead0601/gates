...
module testbench ();
   ...
   wire   N_BWR        ; //: pin11 : Active low write signal Buffered Write (according to earlier docs, gated MA5,/IORQ, and A10 		    
   ...
   mioc_replay mioc_stim (
		  ...
		  .RA7(RA7),                      
		  .nBUSRQ(BUSRQ_N),		  
		  .nEOS_ENABLE(SPINDIS_N),	  
		  .nNET_RST(NETRST_N),		  
		  .nAUX_DECODE1(AUXDECODE1_N),	  
		  .nRST(RST_N),			  
		  .nAUX_ROM_CS(AUXROMCS_N),	  
		  .nADDRBUFEN(ADDRBUFEN_N),	  
		  .nBOOT_ROM_CS(BOOTROMCS_N),	  
		  .nEN245(EN245_N),		  
		  .nIS3(IS3_N),			  
		  .MUX(MUX),			  
		  .nRAS1(RAS_N),		  
...
`endif
   ...
   initial begin
      ...
      // Let stim module kill the sim at EOF
